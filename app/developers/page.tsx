...
import DeveloperIntegrationFlow from "@/components/sections/DeveloperIntegrationFlow";
...
export const metadata: Metadata = {
  title: "Bitcoin Swap SDK for Developers",
  description: "Integrate non-custodial swaps between Bitcoin and stablecoins with the Satora TypeScript SDK.",
  alternates: {
