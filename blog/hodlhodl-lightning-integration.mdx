---
title: "Trade Bitcoin peer-to-peer at Lightning fast: HodlHodl integrates Satora swaps"
subtitle: "Lightning trading is now live on HodlHodl Mainnet, powered by integrations with Arkade and Satora."
date: "2026-05-21"
author: "Marius Off-Chain"
authorImage: "/favicon/dot.svg"
titleImage: "/assets/images/blog/trade_bitcoin_peer_to_peer_lightning_fast_hodlhodl_integrates_satora_swaps.jpg"
excerpt: "Hodl Hodl brings Lightning trading to mainnet with Arkade escrows and Satora swaps."
tags: ["satora", "announcement", "atomic-swaps", "integration"]
---
...
![Drawing of HodlHodl's Arkade contract flow](/assets/images/blog/escrow-drawing.jpg)
...
[Users can now access Lightning trading directly on Hodl Hodl](https://hodlhodl.com/).
...
You can try Satora swaps directly at [app.satora.io](https://app.satora.io/). For developers and integrators who want to understand the infrastructure in more detail, the technical documentation is available at [docs.satora.io](https://docs.satora.io/).

For a different use case, you can also [swap Bitcoin to USDC](/swap/bitcoin-to-usdc), choosing Lightning as your sending network if your wallet supports it.
